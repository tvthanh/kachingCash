<div class="modal fade left media-modal" id="productLibraryModal" tabindex="-1" role="dialog" aria-labelledby="productLibraryModal">
      ...
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <div id="signupbutton" class="form-container">
            ...
            <button class="btn btn-primary" data-dismiss="modal" aria-label="Close">Select</button>
          </div>
