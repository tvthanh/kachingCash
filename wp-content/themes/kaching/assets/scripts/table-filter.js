...
!function ($) {
    ...
    var createControls = function (that, header) {
        ...
        if (addedFilterControl) {
            ...
            header.off('click', '.close-search').on('click', '.close-search', function (event) {
                clearTimeout(timeoutId);
                timeoutId = setTimeout(function () {
                    that.onColumnSearch(event);
                }, that.options.searchTimeOut);
        ...
        if (this.options.filterControl && this.options.filterShowClear) {
            ...
            if (!$btnClear.length) {
              $btnClear = $([
                    ...
                    '<i class="icon-closefilter close-search"></i> '
                    ].join('')).appendTo($('thead th:last .fht-cell'));
    ...
    // $('.close-search').off('click').on('click', $.proxy($('#tabletest').bootstrapTable.clearData, $('#tabletest').bootstrapTable));    
}(jQuery);
/* jshint ignore:end */