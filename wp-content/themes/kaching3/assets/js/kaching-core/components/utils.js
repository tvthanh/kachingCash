    ...
    angular.module('kachingCore')
        .factory('utils', [ function() {
            ...
            var cleanupUploaderQueue = function( uploader ) {
                var videoItems = [], audioItems = [], imageItems = [], wt3AndImageItems = [];
            ...
            var setCampaignId = function(value) {
                campaignId = value;
            };
            ...
            var setViewDetail = function(value) {
                viewDetail = value;
            };
            ...
            var helper = {
                ...
                isWikiTude: function(url) {
                    var type =  '|' + url.slice(url.lastIndexOf('.') + 1) + '|';
                    return '|wt3|'.indexOf(type) !== -1;
                }
            };

            var getArType = function(url) {
